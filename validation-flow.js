...
}, title), totalSteps > 0 && /*#__PURE__*/React.createElement("div", {
  style: {
    display: 'flex',
...
const MethodSelector = ({
  ...
  return /*#__PURE__*/React.createElement(FlowShell, {
    title: "ADAUG\u0102 BILET",
    step: 0,
    totalSteps: 4,
    onClose: onClose
  ...
  }, t('ticket.add.title')), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 6,
      fontSize: 14,
      color: 'var(--color-text-secondary)'
    }
  }, t('ticket.add.subtitle'))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 14
  ...
  }, "Datele biletului t\u0103u r\u0103m\xE2n pe acest telefon. Nu le \xEEnc\u0103rc\u0103m nic\u0103ieri."));
};
const MethodCard = ({
  icon,
  title,
...
const PhotoFlow = ({
  ...
  const pickSource = kind => {
    setSub('capture');
    if (fileRef.current) {
      if (kind === 'camera') fileRef.current.setAttribute('capture', 'environment');else fileRef.current.removeAttribute('capture');
  ...
  if (sub === 'source' || sub === 'capture') {
    return /*#__PURE__*/React.createElement(FlowShell, {
    ...
    }, t('ticket.photo.source.title')), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        flexDirection: 'column',
        gap: 10,
      ...
      size: 20,
      stroke: "#fff"
    }), t('ticket.photo.source.camera')), /*#__PURE__*/React.createElement("button", {
  ...
  // preview
  return /*#__PURE__*/React.createElement(PhotoPreview, {
    photoUri: photoUri,
    onRetake: () => {
      setPhotoUri(null);
      setSub('source');
...
const PhotoPreview = ({
  ...
  return /*#__PURE__*/React.createElement(FlowShell, {
  ...
  }, t('ticket.preview.title')), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 4,
      fontSize: 13,
      color: 'var(--color-text-secondary)',
  ...
  }, t('ticket.preview.subtitle')), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      minHeight: 200,
  ...
  }, !photoUri && /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#fff',
      opacity: 0.5
    }
  }, "Se \xEEncarc\u0103...")), /*#__PURE__*/React.createElement("button", {
  ...
  }, confirmed && /*#__PURE__*/React.createElement(Icon, {
    name: "check",
    size: 14,
    stroke: "#fff",
    strokeWidth: 3.2
  ...
  }, /*#__PURE__*/React.createElement("strong", null, "Confirm c\u0103 \xEEn poz\u0103 se v\u0103d clar:"), /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'block',
      marginTop: 3,
      fontSize: 12,
  ...
  }, "codul biletului \xB7 data evenimentului \xB7 numele festivalului"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 10,
      marginTop: 12
    ...
    size: 14,
    stroke: "var(--hf-bleumarin)"
  }), t('ticket.preview.retake')), /*#__PURE__*/React.createElement("button", {
    className: "hf-btn hf-btn-primary",
    disabled: !confirmed,
  ...
  }, t('ticket.preview.continue'), /*#__PURE__*/React.createElement(Icon, {
    name: "arrowRight",
    size: 14,
    stroke: "#fff"
  }))));
...
const QRFlow = ({
  ...
  const simulateValid = () => {
    onComplete({
      type: 'qr',
      qrData: 'https://livetickets.ro/event/hit-fest-bucovina-2026/order/A7F2K9'
    });
  };
  ...
  if (phase === 'permission' || phase === 'denied') {
    ...
    }, denied ? /*#__PURE__*/React.createElement(Icon, {
      name: "close",
      size: 16,
      stroke: "#fff",
      strokeWidth: 2.8
    ...
    }, denied ? 'CAMERA E BLOCATĂ' : t('ticket.qr.permission.title')), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 14,
        color: 'var(--color-text-secondary)',
        maxWidth: 290,
    ...
    }, denied ? 'Ai refuzat accesul mai devreme. Activează camera din setările telefonului, sau folosește metoda foto.' : t('ticket.qr.permission.subtitle')), denied && /*#__PURE__*/React.createElement("div", {
      style: {
        width: '100%',
        maxWidth: 320,
        padding: 12,
    ...
    }, "iOS:"), /*#__PURE__*/React.createElement("div", null, "Set\u0103ri \u2192 Hit Fest Bucovina \u2192 Camer\u0103 \u2192 Permite"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontWeight: 700,
        color: 'var(--hf-bleumarin)',
        marginTop: 8,
    ...
    }, "Android:"), /*#__PURE__*/React.createElement("div", null, "Set\u0103ri \u2192 Aplica\u021Bii \u2192 Hit Fest Bucovina \u2192 Permisiuni \u2192 Camer\u0103")), /*#__PURE__*/React.createElement("button", {
      className: "hf-btn hf-btn-primary",
      onClick: () => {
        if (denied) {
    ...
    }, denied ? 'DESCHIDE SETĂRI' : t('ticket.qr.permission.cta')), /*#__PURE__*/React.createElement("button", {
    ...
    }, "Folose\u0219te metoda foto \xEEn schimb"), !denied && /*#__PURE__*/React.createElement("button", {
  ...
  return /*#__PURE__*/React.createElement(FlowShell, {
  ...
  }, [[0, 0, 'tl'], [1, 0, 'tr'], [0, 1, 'bl'], [1, 1, 'br']].map(([x, y, k]) => /*#__PURE__*/React.createElement("span", {
    key: k,
    style: {
      position: 'absolute',
      top: y ? 'auto' : 0,
  ...
  }, t('ticket.qr.scanning.hint')), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      opacity: 0.7,
      marginTop: 4
    }
  }, t('ticket.qr.scanning.hint2'))), phase === 'invalid' && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      inset: 0,
    ...
    size: 16,
    stroke: "var(--hf-coral)"
  }), t('ticket.qr.invalid'))), phase === 'failed' && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      inset: 0,
  ...
  }, t('ticket.qr.failed.title')), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 8,
      fontSize: 13,
      color: 'var(--color-text-secondary)',
  ...
  }, t('ticket.qr.failed.message')), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      marginTop: 16
  ...
  }, t('ticket.qr.failed.retry')), /*#__PURE__*/React.createElement("button", {
    onClick: onSwitchToPhoto,
    className: "hf-btn hf-btn-primary",
    style: {
      flex: 1,
  ...
  }, t('ticket.qr.failed.tryPhoto')))))), typeof location !== 'undefined' && /[?&]demo=1/.test(location.search) && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 14,
      padding: '10px 14px',
      background: 'var(--hf-crem-2)',
  ...
  }, "DEMO \xB7 simuleaz\u0103 scanner"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 6
    }
  ...
  }, "QR valid"), /*#__PURE__*/React.createElement("button", {
    onClick: simulateInvalid,
    style: {
      flex: 1,
      padding: '8px 10px',
      fontSize: 12,
  ...
  }, "QR invalid"), /*#__PURE__*/React.createElement("button", {
  ...
  }, "E\u0219ec"))), !(typeof location !== 'undefined' && /[?&]demo=1/.test(location.search)) && /*#__PURE__*/React.createElement("button", {
    onClick: simulateValid,
...
const EmailCapture = ({
  ...
  return /*#__PURE__*/React.createElement(FlowShell, {
  ...
  }, t('email.capture.title')), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 6,
      fontSize: 14,
      color: 'var(--color-text-secondary)',
  ...
  }, t('email.capture.subtitle')), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      padding: '10px 12px',
  ...
  }, !ticketDraft.photoUri && /*#__PURE__*/React.createElement(Icon, {
    name: "qr",
    size: 20,
    stroke: "#fff"
  })), /*#__PURE__*/React.createElement("div", {
  ...
  }, t('email.capture.ticket_added'), " \xB7 ", t('tickets.tag.' + ticketDraft.type)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: 'var(--color-text-secondary)',
      overflow: 'hidden',
  ...
  }, ticketDraft.type === 'qr' ? (ticketDraft.qrData || '').replace(/^https?:\/\//, '') : 'Foto bilet')), /*#__PURE__*/React.createElement("button", {
  ...
  }, t('email.capture.change_ticket'))), /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      marginTop: 22
    }
  ...
  }, t('email.capture.label')), /*#__PURE__*/React.createElement("input", {
    type: "email",
    inputMode: "email",
    autoComplete: "email",
    value: email,
    ...
    style: {
      ...
      fontSize: 15,
      background: 'var(--hf-paper)',
      border: '2px solid ' + (touched && !valid && email ? 'var(--hf-coral)' : valid ? 'var(--hf-turcoaz)' : 'var(--color-border)'),
      borderRadius: 'var(--r-md)',
      outline: 'none',
      fontFamily: 'var(--ff-body)',
      color: 'var(--hf-bleumarin)',
  ...
  }, touched && !valid && email ? t('email.capture.invalid') : t('email.capture.helper'))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 18,
      display: 'flex',
      flexDirection: 'column',
    ...
    required: true
  }, /*#__PURE__*/React.createElement("span", null, "Am citit ", /*#__PURE__*/React.createElement("a", {
    href: "#",
    onClick: e => {
      e.preventDefault();
      e.stopPropagation();
      window.__hfShowPolicy && window.__hfShowPolicy();
    },
    style: {
      color: 'var(--hf-coral)',
      textDecoration: 'underline',
  ...
  }, "Politica de confiden\u021Bialitate"), " \u0219i sunt de acord")), /*#__PURE__*/React.createElement(CheckRow, {
    checked: marketing,
    onToggle: () => setMarketing(p => !p)
  }, /*#__PURE__*/React.createElement("span", null, t('email.capture.marketing')))), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1
    }
  }), /*#__PURE__*/React.createElement("button", {
...
const SuccessScreen = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(SuccessConfetti, null), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, t('success.title'), " ", /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'inline-block',
      animation: 'hf-wiggle 0.6s ease-in-out 3'
    }
  }, "\uD83C\uDF89")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
  ...
  }, t('success.subtitle')), /*#__PURE__*/React.createElement("div", {
    style: {
      width: '100%',
      maxWidth: 340,
      background: 'var(--hf-paper)',
  ...
  }), copied ? t('success.copied') : t('success.copy')), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10,
      display: 'flex',
      gap: 6,
  ...
  })), "Apple Wallet"), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
    ...
    d: "M2 11h20"
  })), "Google Wallet"))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 14,
      fontSize: 13,
      color: 'var(--color-text-secondary)',
  ...
  }, "Codul r\u0103m\xE2ne salvat pe acest telefon.", email ? /*#__PURE__*/React.createElement(React.Fragment, null, " \u021Ai-l vom trimite \u0219i pe email la ", /*#__PURE__*/React.createElement("strong", null, email), ".") : ' Bilet de tip demo — folosește-l ca să încerci reducerile.'), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: 'var(--color-text-secondary)',
      fontStyle: 'italic',
  ...
  }, t('success.save_hint'))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '0 18px 24px',
      display: 'flex',
      flexDirection: 'column',
  ...
  }, t('success.cta.discounts'), /*#__PURE__*/React.createElement(Icon, {
    name: "arrowRight",
    size: 16,
    stroke: "#fff"
  })), /*#__PURE__*/React.createElement("button", {
  ...
  }, t('success.cta.another'))), /*#__PURE__*/React.createElement("style", null, `
...
const AddTicketFlow = ({
  ...
  const [emailDraft, setEmailDraft] = fS({
    email: '',
    privacy: false,
    marketing: false
  });
  ...
  if (step === 'method') {
    return /*#__PURE__*/React.createElement(MethodSelector, {
      onClose: onClose,
      onPick: m => {
        if (m === 'demo') {
  ...
  if (step === 'photo') {
    return /*#__PURE__*/React.createElement(PhotoFlow, {
  ...
  if (step === 'qr') {
    return /*#__PURE__*/React.createElement(QRFlow, {
      onCancel: () => setStep('method'),
  ...
  if (step === 'email') {
    return /*#__PURE__*/React.createElement(EmailCapture, {
      ticketDraft: draft,
