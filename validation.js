...
const saveUser = u => {
  try {
    localStorage.setItem(HF_USER_KEY, JSON.stringify(u));
  } catch (e) {}
};
const clearUser = () => {
  try {
...
const Mascot = ({
  ...
  const grid = ['________________________________', '_______BBBBBBBBBBBBBB____________', '______BHHHHHHHHHHHHHHB__________', '_____BHHHHHHHHHHHHHHHHB_________', '____BHHHGGGGGGGGGGGGHHB_________', '____BHHHGHFGFGFGFGFGGHB_________', '____BHHHGGGGGGGGGGGGGHB_________', '___BPPPPPPPPPPPPPPPPPPB_________', '___BPPWWPPPPPPPPPPWWPPB_________', '__BPPWBWPPPPPPPPPPWBWPPB________', '__BPPWWPPPPPPPPPPPPWWPPB________', '__BPPPPPPPPRRPPPPPPPPPPB________', '__BPPPPPPRRRRRRPPPPPPPPB________', '__BPPPPPPPRRRRPPPPPPPPPB________', '___BPPPPPPPPPPPPPPPPPPB_________', '____BPPPPPBBBBBBPPPPPPB_________', '_____BBBBBSSSSSSBBBBBB__________', '____BSSSSSSSSSSSSSSSSB__________', '___BSSSSKKKKKKKKKSSSSSB_________', '__BSSSSKKKKKKKKKKKKSSSSB________', '__BSSSSKKHFKKBucKKKKSSSB________', '__BSSSSKKKKKKKKKKKKSSSSB________', '__BSSSSKKHITKFESTKKKSSSB________', '__BSSSSKKKKKKKKKKKKSSSSB________', '__BSSSSKK7-9AUGKKKKKSSSB________', '__BSSSSKKKKKKKKKKKKSSSSB________', '__BSSSSSSSSSSSSSSSSSSSSB________', '___BSSSSSSSSSSSSSSSSSSB_________', '____BSSSSSSSSSSSSSSSSB__________', '_____BBBBSSSSSSSSSSBBB__________', '________BBBBBBBBBBB_____________', '________________________________'];
  ...
  const renderRow = (row, ri) => /*#__PURE__*/React.createElement("div", {
    key: ri,
    style: {
      display: 'flex',
      height: px,
    ...
    let bg = 'transparent';
    if (ch === '_') bg = 'transparent';else if (ch === 'B') bg = C.B;else if (ch === 'H') bg = C.H;else if (ch === 'T') bg = C.T;else if (ch === 'S') bg = C.S;else if (ch === 'P') bg = C.P;else if (ch === 'W') bg = C.W;else if (ch === 'K') bg = C.K;else if (ch === 'R') bg = C.R;else if (ch === 'G') bg = C.G;else if (ch === 'F') bg = C.R; // accent dots in hair stripe
  ...
  }, grid.map(renderRow), /*#__PURE__*/React.createElement("style", null, `
...
const MascotSVG = ({
  ...
  d: "M 50 120 Q 100 110 150 120 L 150 170 Q 100 178 50 170 Z",
  fill: "var(--gen-accent)"
}), /*#__PURE__*/React.createElement("g", {
  transform: "translate(112 132) rotate(-10)"
}, /*#__PURE__*/React.createElement("rect", {
  x: "0",
  y: "0",
  width: "62",
  ...
  textAnchor: "middle",
  letterSpacing: "0.5"
}, "HIT FEST"), /*#__PURE__*/React.createElement("text", {
  x: "31",
  y: "28",
  fontFamily: "var(--ff-display)",
  fontSize: "8",
  ...
  textAnchor: "middle",
  fontWeight: "800"
}, "7-9 AUG"), /*#__PURE__*/React.createElement("text", {
  x: "31",
  y: "37",
  ...
  textAnchor: "middle",
  letterSpacing: "1"
}, "BUCOVINA")), /*#__PURE__*/React.createElement("circle", {
  cx: "46",
  cy: "138",
  r: "11",
  fill: "var(--gen-accent)"
...
const EmptyDiscountsLocked = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, t('discounts.empty.title')), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      lineHeight: 1.55,
  ...
  }, t('discounts.empty.subtitle')), /*#__PURE__*/React.createElement("button", {
    ...
    size: 18,
    stroke: "#fff"
  }), t('discounts.empty.cta')), /*#__PURE__*/React.createElement("button", {
    onClick: onSkip,
    style: {
...
const PartnersBlurredTeaser = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    "aria-hidden": "true"
  }, shown.map(p => /*#__PURE__*/React.createElement(PartnerCard, {
    key: p.id,
    p: p,
    onTap: () => {}
  }))), /*#__PURE__*/React.createElement("div", {
