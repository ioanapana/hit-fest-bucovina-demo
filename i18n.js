...
const STRINGS = {
  ro: {
    ...
    'nav.photo': 'Photo',
    'nav.map': 'Hartă',
    'header.tickets': 'BILETE',
    'header.your_gen': 'Generația ta',
    'home.coming_up': 'URMEAZĂ',
    'home.see_lineup': 'VEZI LINE-UP COMPLET',
    'home.buy_ticket': 'CUMPĂRĂ BILET · 240 LEI',
    'home.artists': 'ARTIȘTI',
    'home.days': 'ZILE',
    'home.favorites': 'FAVORIȚI',
    'home.countdown_to': 'MAI SUNT',
    'home.host_intro': 'Prezentat de',
    'home.host_all3': 'toate cele 3 zile',
    'home.see_artist': 'VEZI ARTISTUL',
    'home.your_gen_label': 'GENERAȚIA TA',
    'count.d': 'ZILE',
    'count.h': 'ORE',
    'count.m': 'MIN',
    'count.s': 'SEC',
    'lineup.full': 'FULL LINE-UP',
    'lineup.summary': '17 artiști pe 3 zile · gazdă Liviu Vârciu',
    'lineup.headliner': 'HEADLINER',
    'settings.title': 'SETĂRI',
    'settings.language': 'LIMBĂ',
    'settings.theme': 'GENERAȚIA TA',
    'settings.about': 'DESPRE',
    'settings.notifications': 'NOTIFICĂRI',
    'settings.notif_lineup': 'Schimbări de program',
    'settings.notif_lineup_d': 'Anunț când se schimbă orarul',
    'settings.notif_next': 'Următorul artist',
    'settings.notif_next_d': 'Cu 15 min înainte de show',
    'settings.notif_partners': 'Oferte parteneri',
    'settings.notif_partners_d': 'Reduceri noi adăugate',
    'settings.reset': 'Resetează aplicația',
    'settings.reset_confirm': 'Sigur? Vei pierde codurile și favoritele.',
    'settings.version': 'Hit Fest Bucovina · v1.0',
    'settings.edition': 'Ediția 2026',
    'settings.contact': 'Contact organizator',
    'settings.privacy': 'Politica de confidențialitate',
    'settings.terms': 'Termeni & condiții',
    'settings.credits': 'Made with ♥ for Bucovina',
    'common.back': 'Înapoi',
    'common.close': 'Închide',
    'common.save': 'Salvează',
    'theme.casete.label': 'Generația Casete',
    'theme.cd.label': 'Generația CD',
    'theme.mp3.label': 'Generația MP3',
    'theme.casete.years': 'Născut <1990',
    'theme.cd.years': 'Născut 1990–2000',
    'theme.mp3.years': 'Născut >2000',
    'lang.label': 'Limba',
  ...
  en: {
    ...
    'header.your_gen': 'Your generation',
    'home.coming_up': 'COMING UP',
    'home.see_lineup': 'SEE FULL LINE-UP',
    'home.buy_ticket': 'BUY TICKET · 240 LEI',
    'home.artists': 'ARTISTS',
    'home.days': 'DAYS',
    'home.favorites': 'FAVORITES',
    'home.countdown_to': 'COUNTDOWN',
    'home.host_intro': 'Hosted by',
    'home.host_all3': 'all 3 days',
    'home.see_artist': 'SEE ARTIST',
    ...
    'count.s': 'SEC',
    'lineup.full': 'FULL LINE-UP',
    'lineup.summary': '17 artists across 3 days · hosted by Liviu Vârciu',
    'lineup.headliner': 'HEADLINER',
    'settings.title': 'SETTINGS',
    'settings.language': 'LANGUAGE',
    'settings.theme': 'YOUR GENERATION',
    'settings.about': 'ABOUT',
    'settings.notifications': 'NOTIFICATIONS',
    'settings.notif_lineup': 'Schedule changes',
    'settings.notif_lineup_d': 'Get notified when times shift',
    'settings.notif_next': 'Next artist',
    'settings.notif_next_d': '15 min before each show',
    'settings.notif_partners': 'Partner offers',
    'settings.notif_partners_d': 'New discounts added',
    'settings.reset': 'Reset the app',
    'settings.reset_confirm': 'Sure? You will lose codes and favorites.',
    'settings.version': 'Hit Fest Bucovina · v1.0',
    'settings.edition': '2026 Edition',
    ...
    'tickets.tag.qr': 'QR',
    'theme.casete.label': 'Cassette Generation',
    'theme.cd.label': 'CD Generation',
    'theme.mp3.label': 'MP3 Generation',
    'theme.casete.years': 'Born <1990',
    'theme.cd.years': 'Born 1990–2000',
    'theme.mp3.years': 'Born >2000',
    'lang.label': 'Language',
  ...
  uk: {
    ...
    'nav.photo': 'Фото',
    'nav.map': 'Мапа',
    'header.tickets': 'КВИТКИ',
    'header.your_gen': 'Твоє покоління',
    'home.coming_up': 'ДАЛІ',
    'home.see_lineup': 'ПОВНИЙ ЛАЙН-АП',
    'home.buy_ticket': 'КУПИТИ КВИТОК · 240 LEI',
    'home.artists': 'АРТИСТИ',
    'home.days': 'ДНІ',
    'home.favorites': 'ОБРАНІ',
    'home.countdown_to': 'ЗАЛИШИЛОСЬ',
    'home.host_intro': 'Ведучий',
    'home.host_all3': 'усі 3 дні',
    'home.see_artist': 'ПЕРЕГЛЯНУТИ',
    'home.your_gen_label': 'ТВОЄ ПОКОЛІННЯ',
    'count.d': 'ДНІ',
    'count.h': 'ГОД',
    'count.m': 'ХВ',
    'count.s': 'СЕК',
    'lineup.full': 'ПОВНИЙ ЛАЙН-АП',
    'lineup.summary': '17 артистів за 3 дні · ведучий Лівіу Вирчу',
    'lineup.headliner': 'ХЕДЛАЙНЕР',
    'settings.title': 'НАЛАШТУВАННЯ',
    'settings.language': 'МОВА',
    'settings.theme': 'ТВОЄ ПОКОЛІННЯ',
    'settings.about': 'ПРО ДОДАТОК',
    'settings.notifications': 'СПОВІЩЕННЯ',
    'settings.notif_lineup': 'Зміни розкладу',
    'settings.notif_lineup_d': 'Сповіщати про зміни часу',
    'settings.notif_next': 'Наступний артист',
    'settings.notif_next_d': 'За 15 хв до виступу',
    'settings.notif_partners': 'Пропозиції партнерів',
    'settings.notif_partners_d': 'Нові знижки',
    'settings.reset': 'Скинути додаток',
    'settings.reset_confirm': 'Точно? Втратиш коди та обране.',
    'settings.version': 'Hit Fest Bucovina · v1.0',
    'settings.edition': 'Видання 2026',
    ...
    'theme.casete.label': 'Покоління Касет',
    'theme.cd.label': 'Покоління CD',
    'theme.mp3.label': 'Покоління MP3',
    'theme.casete.years': 'Рік <1990',
    'theme.cd.years': '1990–2000',
    'theme.mp3.years': '>2000',
    'lang.label': 'Мова',
...
const loadLang = () => {
  try {
    return localStorage.getItem(HF_LANG_KEY) || 'ro';
  } catch (e) {
    return 'ro';
  }
};
const saveLang = id => {
  try {
    localStorage.setItem(HF_LANG_KEY, id);
  } catch (e) {}
};

// Simple translator: t('key') -> string in current lang, falls back to RO, then key.
const _LangContext = React.createContext({
  lang: 'ro',
  setLang: () => {}
});
const useT = () => {
...
const LangProvider = ({
  ...
  return React.createElement(_LangContext.Provider, {
    value: {
      lang,
      setLang
    }
...
const LanguageToggle = ({
  ...
  }, current.flag), /*#__PURE__*/React.createElement("span", null, current.short)), open && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, l.native), lang === l.id && /*#__PURE__*/React.createElement(Icon, {
    name: "check",
    size: 14,
